...
class DataEdit extends DataForm
{
    ...
    protected function sniffStatus()
    {
        ...
        if ($this->url->value('show' . $this->cid)) {
            ...
            ///// create /////
        } elseif (false === $this->url->value('show' . $this->cid . '|modify' . $this->cid . '|create' . $this->cid . '|delete' . $this->cid)) {
            $this->status = 'create';
            $this->method = 'post';
    ...
    protected function buildButtons()
    {
        ...
        //crete
        if ('create' == $this->status && 'delete' != $this->action) {
            $this->submit(trans('rapyd::rapyd.save'), $saveButtonPosition);
        }
        //delete
