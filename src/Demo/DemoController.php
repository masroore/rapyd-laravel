...
class DemoController extends Controller
{
    ...
    public function getSchema()
    {
        ...
        //create all tables
        Schema::table('demo_users', static function ($table) {
            $table->create();
            $table->increments('id');
        ...
        Schema::table('demo_articles', static function ($table) {
            $table->create();
            $table->increments('id');
        ...
        Schema::table('demo_article_detail', static function ($table) {
            $table->create();
            $table->increments('id');
        ...
        Schema::table('demo_comments', static function ($table) {
            $table->create();
            $table->increments('id');
        ...
        Schema::table('demo_categories', static function ($table) {
            $table->create();
            $table->increments('id');
        ...
        Schema::table('demo_article_category', static function ($table) {
            $table->create();
            $table->integer('article_id')->unsigned();
    ...
    public function getMenusSchema()
    {
        ...
        Schema::create('demo_menus', static function ($table) {
            $table->increments('id');
            $table->string('title');
    ...
    public function getGrid()
    {
        ...
        $grid->row(static function ($row) {
            if (20 == $row->cell('id')->value) {
    ...
    public function anyForm()
    {
        ...
        $form->saved(static function () use ($form) {
    ...
    public function anyAdvancedform()
    {
        ...
        $form->add('author.fullname', 'Author', 'autocomplete')->search(['firstname', 'lastname'])->limit(5);
